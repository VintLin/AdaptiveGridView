...
import com.voter.adaptivegridview.bean.GirdViewAction
import com.voter.adaptivegridview.bean.*
import com.voter.adaptivegridview.pool.ObjectPool
import com.voter.adaptivegridview.pool.ObjectPoolFactory
import com.voter.adaptivegridview.bean.GridItemInfo

/**
 * 自适应网格布局适配器
 * 由外层的RecyclerView及内层的LinearLayout组成
 */
abstract class BaseGridAdapter : RecyclerView.Adapter<BaseGridAdapter.BaseViewHolder>(), View.OnClickListener, View.OnLongClickListener {
    companion object {
